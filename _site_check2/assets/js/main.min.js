...
window.toggleTOC=()=>{var e=document.getElementById("page-toc"),t=document.getElementById("toc-toggle-icon");e&&t&&("none"===e.style.display?(e.style.display="block",t.innerHTML="&#9660;"):(e.style.display="none",t.innerHTML="&#9654;"))},document.addEventListener("DOMContentLoaded",function(){var e=document.getElementById("page-toc-wrapper"),t=document.getElementById("toc-list"),n=document.querySelectorAll(".page__content h2, .page__content h3, .page__content h4, .page__content h5, .page__content h6");e&&t&&0<n.length&&(n.forEach(function(e){var n=e.textContent.trim(),o=e.id;if(n&&o){var i=document.createElement("li");i.className="toc-item toc-level-"+e.tagName.substring(1);var c=document.createElement("a");c.href="#"+o,c.className="toc-link",c.textContent=n,i.appendChild(c),t.appendChild(i)}}),0<t.children.length&&(e.style.display="block",window.addEventListener("scroll",function(){var e="";n.forEach(function(t){var n=t.offsetTop;window.pageYOffset>=n-100&&(e=t.getAttribute("id"))}),t.querySelectorAll(".toc-link").forEach(function(t){t.classList.remove("active"),t.getAttribute("href")==="#"+e&&t.classList.add("active")})})))});
