...
* An investor has the following monthly returns for their portfolio over the last five months: The risk-free rate is 0.5% per month. What is the annualized Sharpe ratio for this portfolio?
  * A) 0.46
  * B) 0.51
  * C) 1.59
  * D) 1.78
...
* Given the daily closing price of a stock as follows. Assume risk free rate is 1%. What is the Calmar ratio?
  * A) -3.11
  * B) -2.91
  * C) 0.91
  * D) 2.91
...
* An investor has the following monthly returns for their portfolio over the last 6 months: The risk-free rate is 0.5%. What is the Sortino ratio for this portfolio?
  * A) 0.34
  * B) 0.37
  * C) 0.47
  * D) 1.18
